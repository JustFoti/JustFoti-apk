...
// OPTIMIZED: Increased from 10s to 30s to match new client heartbeat interval (60s)
// This allows heartbeats through while still preventing spam
const MIN_HEARTBEAT_GAP = 30000; // 30 seconds minimum between heartbeats
