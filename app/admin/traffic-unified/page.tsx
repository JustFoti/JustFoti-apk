 ...
 * geographic distribution, and external proxy analytics using the unified stats context.
 */
  ...
  if (loading && !trafficData) {
    return (
      <div style={{ textAlign: 'center', padding: '60px', color: '#94a3b8' }}>
        ...
        Loading unified traffic analytics...
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              ...
              <p style={{ margin: '8px 0 0 0', color: '#94a3b8', fontSize: '16px' }}>
                Comprehensive traffic analysis with bot detection, real-time presence monitoring, and geographic insights
              </p>
            </div>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '24px', flexWrap: 'wrap' }}>
          {[
            ...
            { id: 'presence', label: '🟢 Live Presence', count: stats.liveUsers || 0 },
          ].map((tab) => (
            <button 
              key={tab.id} 
        ...
        {activeTab === 'overview' && (
          <div style={{ display: 'grid', gap: '24px' }}>
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '20px', color: '#f8fafc' }}>
                🔴 Real-Time Activity
              </h2>
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px' }}>
                  ...
                  <StatCard 
                    ...
                    value={`${trafficData.totals.total_hits > 0 ? Math.round((trafficData.totals.bot_hits / trafficData.totals.total_hits) * 100) : 0}%`} 
                    icon="📈" 
                    color="#ec4899" 
                  />
                </div>
            ...
            {/* Bot Detection Metrics from Unified Context */}
            {stats.botDetection && (
              <div style={{
                background: 'rgba(15, 15, 35, 0.8)',
                borderRadius: '16px',
                    ...
                    return (
                      <div key={country.country} style={{
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                          <span style={{ fontWeight: '500' }}>{country.countryName}</span>
