			...
			<div className="footer-content">
				<div className="footer-main">
					...
					<div className="footer-social">
						...
						<a href="https://discord.com/users/_vynx" target="_blank" rel="noopener noreferrer" className="social-icon" title="Add @_vynx on Discord" aria-label="Add @_vynx on Discord">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
						...
						<a href="https://github.com/Vynx-Velvet/Flyx-main" target="_blank" rel="noopener noreferrer" className="social-icon" title="GitHub" aria-label="View our GitHub">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
