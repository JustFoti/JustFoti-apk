...
const startString = 'function _0x44b0b9';
...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        ...
        const outputFile = path.join(__dirname, 'helper-function-6.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-6.js");
    } else {
