...
const startString = 'function _0x3a55d6';
...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        ...
        const outputFile = path.join(__dirname, 'helper-function-8.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-8.js");
    } else {
