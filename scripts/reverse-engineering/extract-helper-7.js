...
const startString = 'function _0x3c3f93';
...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        ...
        const outputFile = path.join(__dirname, 'helper-function-7.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-7.js");
    } else {
