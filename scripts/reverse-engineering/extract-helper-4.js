...
const startString = 'function _0x23cd7b';
...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        ...
        const outputFile = path.join(__dirname, 'helper-function-4.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-4.js");
    } else {
