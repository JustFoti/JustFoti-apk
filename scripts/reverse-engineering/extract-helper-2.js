...
const startString = '_0x4ef584=function';
const startIndex = source.indexOf(startString);

if (startIndex !== -1) {
    // It is likely `var _0x4ef584=function...` or `,_0x4ef584=function...`
    ...
    if (endIndex !== -1) {
        const funcCode = 'var _0x4ef584=' + source.substring(funcStart, endIndex) + ';';
        const outputFile = path.join(__dirname, 'helper-function-2.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-2.js");
    } else {
