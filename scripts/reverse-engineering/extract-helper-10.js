...
const startString = 'function _0x199187';
...
if (startIndex !== -1) {
    ...
    if (endIndex !== -1) {
        ...
        const outputFile = path.join(__dirname, 'helper-function-10.js');
        fs.writeFileSync(outputFile, funcCode);
        console.log("Extracted helper function to helper-function-10.js");
    } else {
